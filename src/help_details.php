...
<section class="img-bg shadow-in-bottom backstretch-section">
...
<section>
  <div class="container inner-xs">
    <div class="row">
    <div class="col-md-12 outer-bottom-xs"><?php  $this->inc('elements/breadcrumbs.php'); ?></div>
      <div class="col-lg-8">
        <?php 
		if (!$bg) {
		echo '<h1>'.$title. '</h1>';
      ...
      <div class="col-lg-4">
        ...
        <?php
			$a = new GlobalArea('Sidebar Statisch Help A');
			$a->display();
		?>
        <?php 
	  	$a = new Area('Sidebar');
      ...
      <?php
			$a = new GlobalArea('Sidebar Statisch Help B');
			$a->display();
		?>
      </div>
    </div>
